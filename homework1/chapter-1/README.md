...
#### 1-3 데이터 할당 및 변환에 대한 메모리 영역의 변화
![1-3](./image/1-3.PNG)

### 1-4 참조형 데이터의 프로퍼티 할당
![1-4](./image/1-4.PNG)
...
### 1-9 변수 복사 이후 값 변경 결과 비교(2) - 객체의 프로퍼티 변경 시
![1-9](./image/1-9.PNG)

### 1-10 객체의 가변성에 따른 문제점
![1-10](./image/1-10.PNG)

### 1-11 객체의 가변성에 따른 문제점 해결방법
![1-11](./image/1-11.PNG)
...
### 1-15 중첩된 객체에 대한 얕은 복사
![1-15](./image/1-15.PNG)

### 1-16 객체의 깊은 복사를 수행하는 범용함수
![1-16](./image/1-16.PNG)
